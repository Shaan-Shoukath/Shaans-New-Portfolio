...
export const siteConfig = {
  ...
  description:
    "Shaan Shoukath is a Kochi, Kerala engineer building robotics, geospatial AI, embedded systems, full-stack web and mobile, telecom, and fintech products.",
...
export const baseKeywords = [
  ...
  "shaans.works",
  "adaptive engineer",
  "robotics engineer Kochi",
  "drone engineer Kochi",
  "ROS 2 engineer",
  "multi-drone systems",
  "ArduPilot developer",
  "MAVLink developer",
  "KML mission planning",
  "SITL testing",
...
export function createPageMetadata({
  ...
  const fullTitle =
    title === siteConfig.name
      ? `${siteConfig.name} | Robotics, AI & Full-Stack Engineer`
      : `${title} | ${siteConfig.name}`;
...
export const personJsonLd = {
  ...
  jobTitle: "Multidisciplinary Engineer: Robotics, AI, and Full-Stack Systems",
  ...
  knowsAbout: [
    ...
    "ArduPilot",
    "MAVLink",
    "KML-to-mission waypoint planning",
